...
const Settings = ({setSettings}) => {
  ...
  return (
    <div className="flex flex-col p-3 absolute top-[11vh] right-3 sm:right-6 md:right-12 lg:right-40 w-[20rem] h-[13rem] bg-cta shadow-2xl rounded-lg">
      ...
      <div
        onClick={logout}
        className="flex items-center justify-center cursor-pointer mt-4 w-full h-12 bg-red-600 hover:bg-red-700 rounded-md"
      >
